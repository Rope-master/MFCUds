...
static obd_dtc_t obd_dtc_list[OBD_DTC_CNT] =
{
	...
	{_T("电池电压过低"),   _T("U300316"), 0xF00316, 0, 0 },
	{_T("电池电压过高"),   _T("U300317"), 0xF00317, 0, 0 },
	{_T("ECU总线关闭"),    _T("U007388"), 0xC07388, 0, 0 },
	{_T("EMS通信丢失"),    _T("U010001"), 0xC10001, 0, 0 },
	{_T("TCU通信丢失"),    _T("U010101"), 0xC10101, 0, 0 },
	{_T("ABS通信丢失"),    _T("U012101"), 0xC12101, 0, 0 },
	{_T("TPMS通信丢失"),   _T("U012701"), 0xC12701, 0, 0 },
	{_T("EPB通信丢失"),    _T("U012801"), 0xC12801, 0, 0 },
	{_T("ESP通信丢失"),    _T("U012901"), 0xC12901, 0, 0 },
	{_T("EPS通信丢失"),    _T("U013101"), 0xC13101, 0, 0 },
	{_T("BCM通信丢失"),    _T("U014100"), 0xC14000, 0, 0 },
	{_T("SRS通信丢失"),    _T("U015101"), 0xC15101, 0, 0 },
	{_T("DVD通信丢失"),    _T("U016300"), 0xC16300, 0, 0 },
	{_T("PDC通信丢失"),    _T("U016900"), 0xC16900, 0, 0 },
	{_T("ALS通信丢失"),    _T("U018101"), 0xC18101, 0, 0 },
	{_T("PEPS通信丢失"),   _T("U023601"), 0xC23601, 0, 0 },
	{_T("AC通信丢失"),     _T("U016400"), 0xC16400, 0, 0 },
	{_T("AVM通信丢失"),    _T("U016700"), 0xC16700, 0, 0 },
